...
<html lang="es">
  <head>
    <title>AdministracionSInicio</title>
    <meta charset="utf-8"/>
  ...
  <body>
    ...
    <h4 class="center">Administracion de Noticias</h4>

    <div class="section container">
        <form action="opciones.php" method="post" enctype="multipart/form-data">
         <div class="row">
             <div class="input-field col s20 m4">
                 <p></p>
                 <select name="opcion">
                     <option value="" disabled selected></option>
                     <option value="7">Modificar Noticia</option>
                     <option value="8">Agregar Noticia</option>
                     <option value="9">Eliminar Noticia</option>
                 </select>
                 <label class="black-text col2" for="opcion" ><h6>¿Que deseas Hacer?</h6></label>
             </div> 
            <div class="col s12">
