...
<html lang="es">
  <head>
    ...
    <meta name="descripcion" content="Sistema de consultas"/>
    ...
    <nav class="cyan darken-2">
      <div class="nav-wrapper">
        ...
        <ul class="sidenav grey lighten-4" id="menu">
          ...
          <li><a class="cyan-text text-darken-2" href="gestorPrincipal.html">Regresar a menu principal<i class="material-icons right black-text">arrow_back</i></a></li>
        </ul>
        ...
        <ul id="desplegable_gastos" class="dropdown-content">
          ...
          <li class="divider blue-grey lighten-5"></li>
          <li><a class="cyan-text text-darken-2" href="consultarGInsumo.php">Gastos en Insumos</a></li>
        </ul>
        ...
        <ul id="desplegable_recursos" class="dropdown-content">
          <li><a class="cyan-text text-darken-2" href="consultarRAlimento.php">Alimentos</a></li>
          <li class="divider blue-grey lighten-5"></li>
