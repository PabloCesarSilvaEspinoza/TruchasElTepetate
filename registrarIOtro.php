<!DOCTYPE html>
<!--Página registrar ingresos -->
<html lang="es">
  <head>
    <title> Sistema de Registro de ingresos multiples</title>
    <meta charset="utf-8"/>
    <meta name="keywords" content=""/>
    <meta name="descripcion" content="Sistema de registros de ingresos multiples"/>
  ...
  <body>
    ...
    <div class="row">
      <div class="input-field col s11 m4">
        <label class="black-text" for="gasto">Ingreso</label>
        <input placeholder="Ingresa monto del ingreso" id="contra" type="number" class="validate" required>
      </div>
      <div class="input-field col s11 m6 push-m3">
        <label class="black-text" for="descrip">Descripción</label>
        <input placeholder="Ingresa una descripción (Opcional)" id="descrip" type="text" class="validate">
      </div>
      <div class="col s12">
