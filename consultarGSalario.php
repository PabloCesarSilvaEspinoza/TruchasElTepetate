<?php
    	include ('bd.php');
		$query= 'SELECT empleado, descripcion, fecha, costo
        FROM gastoop
        WHERE empleado!="Gasto Operacional" ORDER BY fecha desc';
...
<html lang="es">
  ...
  <body>
    ...
    <div class="container">
    <h4 class="center">Gastos salarios</h4>
...
<script src="js/consultaGSalario.js"></script>
