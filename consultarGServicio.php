<?php
    	include ('bd.php');
		$query= 'SELECT *
		From gastoop WHERE empleado="Gasto Operacional" ORDER BY fecha desc';
		$result=bd_consulta($query);

        $query1='SELECT nombre
            FROM usuario
            INNER JOIN gastoop
            ON usuario.idUsuario=gastoop.idAdministrador
            WHERE empleado="Gasto Operacional"
            ORDER BY gastoop.fecha desc ';
...
<html lang="es">
  <head>
    <title> Sistema de Consulta de gastos de servicio</title>
    <meta charset="utf-8"/>
    <meta name="keywords" content=""/>
    <meta name="descripcion" content="Sistema de consulta de gastos de servicio"/>
  ...
  <body>
    ...
    <div class="container">
    <h4 class="center">Gastos servicios</h4>
    ...
    <div class="section container">
     ...
     <!--<DIV align="right"><strong>Total de los Gastos de Operacion = <?php echo $total; ?></strong></DIV>-->
...
<script src="js/consultaGServicio.js"></script>
