<?php
    include('bd.php');
    $opc=$_POST['opcion'];
    $query="SELECT * FROM receta WHERE idReceta='$opc'";
...
<html lang="es">
  ...
  <body>
    ...
    <h4 class="center">Modificar Receta</h4>
          ...
          <div class="row">
            ...
            <div class="input-field col s12">      
                <textarea class="black-text" for="opc" id="opc" name="opc"style="display:none;">
                    <?php echo $row['idReceta']?>    
                </textarea>

            </div>
            
            <div class="input-field col s12">      
              <label class="black-text" for="titulo">Nombre</label>
              <textarea  id="titulo" name="titulo" class="materialize-textarea" required><?php echo "".$row['titulo'].""?></textarea>
            </div>
              
            <div class="input-field col s12">
              <label class="black-text" for="ingredientes">Ingredientes</label>
              <textarea id="ingredientes" name="ingredientes" class="materialize-textarea" required><?php echo "".$row['ingredientes']."" ?></textarea>
            </div>
                    
            <div class="input-field col s12">
              <label class="black-text" for="pasos">Pasos</label>
              <textarea id="pasos" name="pasos" class="materialize-textarea"required><?php echo "".$row['pasos']."" ?></textarea>
            </div>
            
            <div class="input-field col s12">   
              <label class="black-text" for="resumen">Resumen</label>
              <textarea id="resumen" name="resumen" class="materialize-textarea" required><?php echo "".$row['resumen']."" ?></textarea>
            </div>
              
            <div class="input-field col s12">   
              <label class="black-text" for="autor">Autor</label>
              <textarea id="autor" name="autor" class="materialize-textarea"required><?php echo "".$row['autor']."" ?></textarea>
            </div>
                   
            <div class="col s12">
            <div class='card-image'>
            <?php echo"
            <img  style='height:100%; width:350px;' class='responsive-img' src='data:image/*;base64,".base64_encode($row['fotoreceta'])."'"
