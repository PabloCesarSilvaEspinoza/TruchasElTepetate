<?php
    include('bd.php');
    $id=$_POST['opcion'];
        $query="SELECT idStock,cantidad,peso,nombrePresentacion,unidadMedida
        FROM stock
        INNER JOIN presentacion
        ON stock.idPresentacion=presentacion.idPresentacion WHERE idStock='$id'
        ";
...
<html lang="es">
  ...
  <body>
    ...
    <nav class="cyan darken-2">
      <div class="nav-wrapper">
        ...
        <ul id="desplegable_produccion" class="dropdown-content">
          ...
          <li><a class="cyan-text text-darken-2" href="administrarStock.php">k</a></li>
          <li class="divider blue-grey lighten-5"></li>
    ...
    <div class="section container">
        <form action="ingStock.php" method="post" enctype="multipart/form-data">
          <div class="row">

            <div class="input-field col s12">      
                <textarea class="black-text" for="opc" id="opc" name="opc"style="display:none;">
                    <?php echo $row['idStock']?>    
                </textarea>
            </div>
            ...
            <div class="input-field col s12 m4">
              <label class="black-text" for="precio">Cantidad Producida (Kilos/Piezas)</label><br>
