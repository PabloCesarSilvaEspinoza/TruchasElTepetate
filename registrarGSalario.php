...
<html lang="es">
  <head>
    <title> Sistema de Registro de gastos de salario</title>
    <meta charset="utf-8"/>
    <meta name="keywords" content=""/>
    <meta name="descripcion" content="Sistema de registros de gastos de salarios"/>
  ...
  <body>
    ...
    <h4 class="center">Gastos de Salarios</h4>
    <div class="section container">
      <form action="ingSalario.php" method="post">
    <div class="row">
      <div class="input-field col s11 m4">
        <label class="black-text" for="gasto">Gasto</label>
        <input placeholder="Ingresa monto del pago" id="gasto" name="gasto" type="number" class="validate" step="any"required min=0>
      </div>
      <div class="input-field col s11 m6 push-m3">
        <label class="black-text" for="descrip">Empleado</label>
        <input placeholder="Nombre del Empleado" id="empleado" name="empleado" type="text" class="validate">
      </div>
      <div class="col s12">
