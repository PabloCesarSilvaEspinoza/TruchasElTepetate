...
<html lang="es">
  ...
  <body>
    ...
    <div class="section container">
        <form action="nvoReceta.php" method="post" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="input-field col s12">
              ...
              <textarea id="ingredientes" name="ingredientes" class="materialize-textarea" required></textarea>
            </div>
                    
            <div class="input-field col s12">
              <label class="black-text" for="pasos">Pasos</label>
              <textarea id="pasos" name="pasos" class="materialize-textarea"required></textarea>
            </div>
            
            <div class="input-field col s12">   
              <label class="black-text" for="resumen">Resumen</label>
              <textarea id="resumen" name="resumen" class="materialize-textarea" required></textarea>
            </div>
              
            <div class="input-field col s12">   
              <label class="black-text" for="autor">Autor</label>
              <textarea id="autor" name="autor" class="materialize-textarea"required></textarea>
            </div>
