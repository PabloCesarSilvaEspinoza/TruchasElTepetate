<?php
    include('bd.php');
    $opc=$_POST['opcion'];
    $query="SELECT * FROM noticia WHERE idNoticia='$opc'";
...
<html lang="es">
  ...
  <body>
    ...
    <h4 class="center">Modificar Noticia</h4>
        ...
        <form action="guardarNoticia.php" method="post" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="input-field col s12">      
              ...
              <textarea placeholder="Nombre del Producto" id="titulo" name="titulo" class="materialize-textarea"><?php echo "".$row['titulo']."" ?></textarea>
            </div>
              
            <div class="input-field col s12">
              <label class="black-text" for="resumen">Resumen</label>
              <textarea id="resumen" name="resumen" class="materialize-textarea"><?php echo "".$row['resumen']."" ?></textarea>
            </div>
              
            <div class="input-field col s12">
              <label class="black-text" for="link">Link</label>
            <textarea id="link" name="link" class="materialize-textarea"><?php echo "".$row['link']."" ?></textarea>
            </div>
