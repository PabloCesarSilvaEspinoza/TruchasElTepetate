...
<html lang="es">
  ...
  <body>
    ...
    <h4 class="center">Eliminar "Stock"</h4>

    <div class="section container">
        <form action="eliminarStock.php" method="post" enctype="multipart/form-data">
         <div class="row">
            ...
            ?>
                 ...
                 <label class="black-text col2" for="opcion" ><h6>¿Que producto quieres eliminar?</h6></label>
             </div> 
            <div class="col s12">
