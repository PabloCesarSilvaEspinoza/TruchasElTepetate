...
<html lang="es">
  ...
  <body>
    ...
    <div class="section container">
        <form action="nvoNoticia.php" method="post" enctype="multipart/form-data">
          <div class="row">

            <div class="input-field col s12 m4">      
              <label class="black-text" for="titulo">Titulo</label>
              <textarea placeholder="Titulo de la Noticia" id="titulo" name="titulo" class="materialize-textarea"></textarea>
            </div>
              
            <div class="input-field col s12 m9">
              <label class="black-text" for="resumen">Resumen</label>
              <textarea placeholder="Resumen de la noticia" id="resumen" name="resumen" class="materialize-textarea"></textarea>
            </div>
              
              
            <div class="input-field col s12 m4">
                <label class="black-text" for="link">Link de la Noticia (Opcional)</label>
              <textarea placeholder="Link de la Noticia" id="link" name="link" class="materialize-textarea"></textarea>
            </div>
