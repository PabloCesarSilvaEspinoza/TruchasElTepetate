...
<html lang="es">
  <head>
    <title>Eliminar Estanque</title>
    <meta charset="utf-8"/>
    <meta name="keywords" content=""/>
    <meta name="descripcion" content="Sistema de administración de página web 'Eliminar'"/>
  ...
  <body>
    ...
    <h4 class="center">Elimina Estanque</h4>

    <div class="section container">
        <form action="eliminarEstanque.php" method="post" enctype="multipart/form-data">
            <div class="row">            
                <div class="input-field col s11 m6">
                    <select name="id" required>
                        <option disabled selected>Seleccione Estanque</option>
