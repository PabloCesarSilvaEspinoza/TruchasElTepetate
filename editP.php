<?php
        include('bd.php');
        $query="SELECT idPresentacion,nombrePresentacion,tipoTrucha
        FROM presentacion
        INNER JOIN trucha
        ON presentacion.idTrucha=trucha.idTrucha";
...
<html lang="es">
  ...
  <body>
    ...
    <h4 class="center">Editar "Productos"</h4>
        ...
        <form action="modificarP.php" method="post" enctype="multipart/form-data">
         <div class="row">
            ...
            <?php 
                    ...
                    ?>
				    <OPTION value="<?php echo $row['idPresentacion']?>"><?php echo $row['nombrePresentacion']," Tipo de Trucha ", $row['tipoTrucha'];?></OPTION>
                     <?php 
                    }
        ?>
                 </select>
