<?php
    ...
    $id=$_POST['opcion'];
        $query="SELECT *
        FROM presentacion WHERE idPresentacion='$id'";
...
<html lang="es">
  ...
  <body>
    ...
    <nav class="cyan darken-2">
     ...
     <h4 class="center">Agregar Stock</h4>

    <div class="section container">
        <form action="insStock.php" method="post" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="input-field col s12">      
              ...
              <textarea placeholder="Nombre del Producto" disabled id="nombre" name="nombre" class="materialize-textarea"><?php echo "".$row['nombrePresentacion']."" ?></textarea>
            </div>
            <?php 
                if($row['unidadMedida']=="Kilogramo"){
                    echo"<div class='input-field col s12 m4'>
              <label class='black-text' for='peso'>Peso del Producto</label><br>
            <input id='peso' name='peso' type='number' class='validate' required min=0 step='any'>
            </div>";
                }
                else{
                    echo"<div class='input-field col s12'>      
                <textarea class='black-text' for='peso' id='peso' name='peso'style='display:none';>
                </textarea>
            </div>";
                }
            ?>
            ...
            <div class="input-field col s12 m4">
              <label class="black-text" for="cantidad">Cantidad Producida (Kilos/Piezas)</label><br>
            <input id="cantidad" name="cantidad" type="number" class="validate" required min=0 step="any">
            </div>
