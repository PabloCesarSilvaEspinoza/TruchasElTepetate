...
<html lang="es">
  ...
  <body>
    ...
    <h4 class="center">Elimina Productos</h4>

    <div class="section container">
        <form action="eliminarNoticia.php" method="post" enctype="multipart/form-data">
         <div class="row">
    ...
    <div class="input-field col s11 m6">
       ...
       <?php 
        ...
        <label class="black-text" for="ite">Noticias Mostradas</label>
      </div>
