...
<html lang="es">
  ...
  <body>
    ...
    <h4 class="center">Gastos Operacionales</h4>
    <div class="section container">
      <form action="ingGServicio.php" method="post">
    <div class="row">
        
      <div class="input-field col s11 m4 ">
        <label class="black-text" for="gasto">Monto de la Compra</label>
        <input placeholder="Ingresa monto de la compra" id="cantgast" name="cantgast" type="number" class="validate" required min=0 step="any">
      </div>
        
      <div class="input-field col s11 m6">
        <label class="black-text" for="descrip">Descripcion</label>
        <input placeholder="Descripcion" id="descrip" name="descrip" type="text" class="validate" required>
      </div>
