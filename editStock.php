<?php
        ...
        ON stock.idPresentacion=presentacion.idPresentacion
        ";
...
<html lang="es">
  ...
  <body>
    ...
    <h4 class="center">Editar "Stock"</h4>

    <div class="section container">
        <form action="modificarStock.php" method="post" enctype="multipart/form-data">
         <div class="row">
            ...
            <?php 
                    ...
                    ?>
				    <OPTION value="<?php echo $row['idStock']?>"><?php
                    if($row['unidadMedida']=="Entera"){ echo $row['nombrePresentacion'];}
                    else{
                        echo $row['nombrePresentacion']," Peso ",$row['peso']," Kilogramos";
                    }
            ...
            ?>
                 ...
                 <label class="black-text col2" for="opcion" ><h6>¿Que producto quieres modificar?</h6></label>
             </div> 
            <div class="col s12">
