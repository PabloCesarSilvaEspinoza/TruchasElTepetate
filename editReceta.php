...
<html lang="es">
  ...
  <body>
    ...
    <div class="section container">
        <form action="modificarReceta.php" method="post" enctype="multipart/form-data">
         <div class="row">
        ...
        ?>
                 ...
                 <label class="black-text col2" for="opcion" ><h6>¿Que receta quieres modificar?</h6></label>
             </div> 
            <div class="col s12">
