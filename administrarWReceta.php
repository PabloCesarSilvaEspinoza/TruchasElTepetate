...
<html lang="es">
  <head>
    <title>AdministracionReceta</title>
    <meta charset="utf-8"/>
  ...
  <body>
    ...
    <h4 class="center">Administracion de Recetas</h4>
         ...
         <div class="row">
             <div class="input-field col s20 m4">
                 ...
                 <select name="opcion">
                     ...
                     <option value="10">Modificar Receta</option>
                     <option value="11">Agregar</option>
                     <option value="12">Eliminar</option>
                 </select>
